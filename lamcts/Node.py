...
class Node:
    ...
    def propose_samples_bo1(self, nums_rand_samples,num_samples, path, lb, ub, samples):
        proposed_X = self.classifier.propose_samples_bo1(nums_rand_samples,num_samples, path, lb, ub, samples)
        return proposed_X
