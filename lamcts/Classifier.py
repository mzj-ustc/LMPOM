...
class Classifier():
    def __init__(self, samples, dims, kernel_type, gamma_type = "auto"):
        ...
        kernel = Matern()
        self.gpr =GaussianProcessRegressor(kernel=kernel, alpha=1e-4, n_restarts_optimizer=100, normalize_y=False)
        ...
        self.svm     =   MLPClassifier(activation='tanh', alpha=1e-05, batch_size='auto', beta_1=0.9,
       beta_2=0.999, early_stopping=False, epsilon=1e-08,
       hidden_layer_sizes=(140,280,140), learning_rate='constant',
    ...
    #def propose_samples_bo_well( self, nums_samples = 10, path = None, lb = None, ub = None, samples = None):
    ...
    def propose_samples_bo1( self, nums_rand_samples,nums_samples = 10, path = None, lb = None, ub = None, samples = None):
        ''' Proposes the next sampling point by optimizing the acquisition function. 
        Args: acquisition: Acquisition function. X_sample: Sample locations (n x d). 
        Y_sample: Sample values (n x 1). gpr: A GaussianProcessRegressor fitted to samples. 
        Returns: Location of the acquisition function maximum. '''
